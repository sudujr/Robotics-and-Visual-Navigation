...
def main():
    ...
    bgr_image = util.imageReadBGR('assignment_12.jpg')
    bgr_image_copy = copy.deepcopy(bgr_image)
    gray_image = util.imageReadGray('assignment_12.jpg')
    ...
    util.imageWrite(bgr_image, "output_Harris.jpg")
    ...
    #Save the imag in the system
    util.imageWrite(bgr_image, "output_Harris_cv.jpg")
