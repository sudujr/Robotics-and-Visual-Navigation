...
img = cv2.imread("InputData/assignment2_part2.jpg")
...
cv2.imwrite('Output/Denoised_Image_2.jpg',output)
...
f.tight_layout()
plt.savefig('Histograms/HistofG&Dimages_2.jpg', dpi=300, bbox_inches='tight')
plt.show()
...
plt.savefig('Analysis/Analysis_2.jpg', dpi=300)
plt.show()
...
plt.savefig('Validation/proof_2.jpg', dpi=300)
plt.show()
